...
public abstract interface CategoryDao {
    ...
    @androidx.room.Query(value = "SELECT COALESCE(MAX(`order`), 0) FROM category WHERE type = :type")
    @org.jetbrains.annotations.Nullable
