...
public final class AccountRepositoryImpl implements ru.ohayo.moneypr.data.repository.AccountRepository {
    ...
    ru.ohayo.moneypr.domain.allEntity.Account account, @org.jetbrains.annotations.NotNull
    ...
    @java.lang.Override
    @org.jetbrains.annotations.NotNull
    public kotlinx.coroutines.flow.Flow<java.util.List<ru.ohayo.moneypr.domain.allEntity.Account>> getAllAccounts() {
        return null;
    }
    ...
    kotlin.coroutines.Continuation<? super ru.ohayo.moneypr.domain.allEntity.Account> $completion) {
        return null;
    }
    ...
    java.util.List<ru.ohayo.moneypr.domain.allEntity.Account> accounts, @org.jetbrains.annotations.NotNull
    kotlin.coroutines.Continuation<? super kotlin.Unit> $completion) {
        return null;
    }
